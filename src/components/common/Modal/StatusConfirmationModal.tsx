...
const StatusConfirmationModal: React.FC<StatusConfirmationModalProps> = ({ onClose, onConfirm, currentStatus }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4" aria-modal="true" role="dialog">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-sm">
        <div className="p-6 border-b">
          <h2 className="text-lg font-bold text-gray-900">Status Confirmation</h2>
        </div>
        <div className="p-6">
          <p className="text-base text-gray-700">Do you want to modify the {currentStatus} Status?</p>
        </div>
