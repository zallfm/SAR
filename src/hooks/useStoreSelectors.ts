...
export const useAuthUser = (): User | null => useAuthStore(state => state.currentUser)
...
export const useApplications = (): Application[] => useApplicationStore(state => state.applications)
...
export const useApplicationModals = () => useApplicationStore(state => ({
...
export const useApplicationActions = () => useApplicationStore(state => ({
...
// UI Store Selectors
export const useActiveView = () => useUIStore(state => ({
...
// UAR Store Selectors
export const useUarSystemOwners = (): UarSystemOwnerRecord[] => useUarStore(state => state.systemOwnerRecords)
export const useUarDivisionUsers = (): UarDivisionUserRecord[] => useUarStore(state => state.divisionUserRecords)
export const useUarSelections = () => useUarStore(state => ({
...
export const useFilteredLogs = (): LogEntry[] => useLoggingStore(state => state.filteredLogs)
...
export const useLoggingFilters = () => {
  ...
  const memoizedSetFilters = useCallback((newFilters: any) => {
...
export const useLoggingPagination = () => {
  ...
  const getCurrentPageLogs = useLoggingStore(state => state.getCurrentPageLogs)
  
  const memoizedSetCurrentPage = useCallback((page: number) => {
    setCurrentPage(page)
  }, [setCurrentPage])
  
  const memoizedSetItemsPerPage = useCallback((size: number) => {
  ...
  return useMemo(() => ({
    ...
    getTotalPages,
    getCurrentPageLogs,
  }), [currentPage, itemsPerPage, memoizedSetCurrentPage, memoizedSetItemsPerPage, getTotalPages, getCurrentPageLogs])
}
...
export const useSchedules = (): Schedule[] => useScheduleStore(state => state.schedules)
export const useFilteredSchedules = (): Schedule[] => useScheduleStore(state => state.filteredSchedules)
...
export const useSchedulePagination = () => {
  ...
  const getCurrentPageSchedules = useScheduleStore(state => state.getCurrentPageSchedules)
  ...
  }), [currentPage, itemsPerPage, memoizedSetCurrentPage, memoizedSetItemsPerPage, getTotalPages, getCurrentPageSchedules])
}
...
export const useScheduleActions = () => {
  ...
  return useMemo(() => ({
    ...
    setLoading,
    setError,
  }), [setSchedules, setFilteredSchedules, setSelectedSchedule, addSchedule, updateSchedule, deleteSchedule, setLoading, setError])
}

// UAR PIC Store Selectors
export const usePics = (): PicUser[] => useUarPicStore(state => state.pics)
export const useFilteredPics = (): PicUser[] => useUarPicStore(state => state.filteredPics)
...
export const useUarPicPagination = () => {
  ...
  const getCurrentPagePics = useUarPicStore(state => state.getCurrentPagePics)
  ...
  return useMemo(() => ({
    ...
    getTotalPages,
    getCurrentPagePics,
  }), [currentPage, itemsPerPage, memoizedSetCurrentPage, memoizedSetItemsPerPage, getTotalPages, getCurrentPagePics])
}
...
export const useUarPicActions = () => {
  ...
  return useMemo(() => ({
    ...
    setLoading,
    setError,
  }), [setPics, setFilteredPics, setSelectedPic, addPic, updatePic, deletePic, setLoading, setError])
}

// System Master Store Selectors
export const useSystemMasterRecords = (): SystemMasterRecord[] => useSystemMasterStore(state => state.systemMasterRecords)
export const useFilteredSystemMasterRecords = (): SystemMasterRecord[] => useSystemMasterStore(state => state.filteredRecords)
...
export const useSystemMasterPagination = () => {
  ...
  const setItemsPerPage = useSystemMasterStore(state => state.setItemsPerPage)
  const getTotalPages = useSystemMasterStore(state => state.getTotalPages)
  const getCurrentPageRecords = useSystemMasterStore(state => state.getCurrentPageRecords)
  ...
  }), [currentPage, itemsPerPage, memoizedSetCurrentPage, memoizedSetItemsPerPage, getTotalPages, getCurrentPageRecords])
}

export const useSystemMasterActions = () => {
  const setSystemMasterRecords = useSystemMasterStore(state => state.setSystemMasterRecords)
  const setFilteredRecords = useSystemMasterStore(state => state.setFilteredRecords)
  const setSelectedRecord = useSystemMasterStore(state => state.setSelectedRecord)
  const addSystemMasterRecord = useSystemMasterStore(state => state.addSystemMasterRecord)
  const updateSystemMasterRecord = useSystemMasterStore(state => state.updateSystemMasterRecord)
  const deleteSystemMasterRecord = useSystemMasterStore(state => state.deleteSystemMasterRecord)
  ...
  return useMemo(() => ({
    ...
    setLoading,
    setError,
  }), [setSystemMasterRecords, setFilteredRecords, setSelectedRecord, addSystemMasterRecord, updateSystemMasterRecord, deleteSystemMasterRecord, setLoading, setError])
}

// UAR Progress Store Selectors
export const useUarProgressData = (): UarProgressResponse | null => useUarProgressStore(state => state.progressData)
export const useUarProgressFilteredData = (): UarProgressResponse | null => useUarProgressStore(state => state.filteredData)
...
export const useUarProgressFilters = () => {
  ...
  const memoizedSetFilters = useCallback((newFilters: UarProgressFilters) => {
    setFilters(newFilters)
  }, [setFilters])
...
export const useUarProgressUIState = () => {
  ...
  const selectedDivisionFilter = useUarProgressStore(state => state.selectedDivisionFilter)
  const selectedDepartmentFilter = useUarProgressStore(state => state.selectedDepartmentFilter)
  const selectedSystemFilter = useUarProgressStore(state => state.selectedSystemFilter)
  const drilldownDivision = useUarProgressStore(state => state.drilldownDivision)
  
  const setSelectedPeriod = useUarProgressStore(state => state.setSelectedPeriod)
  const setSelectedDivisionFilter = useUarProgressStore(state => state.setSelectedDivisionFilter)
  const setSelectedDepartmentFilter = useUarProgressStore(state => state.setSelectedDepartmentFilter)
  const setSelectedSystemFilter = useUarProgressStore(state => state.setSelectedSystemFilter)
  const setDrilldownDivision = useUarProgressStore(state => state.setDrilldownDivision)
  
  const memoizedSetSelectedPeriod = useCallback((period: string) => {
    setSelectedPeriod(period)
  }, [setSelectedPeriod])
  
  const memoizedSetSelectedDivisionFilter = useCallback((division: string) => {
    setSelectedDivisionFilter(division)
  }, [setSelectedDivisionFilter])
  
  const memoizedSetSelectedDepartmentFilter = useCallback((department: string) => {
    setSelectedDepartmentFilter(department)
  }, [setSelectedDepartmentFilter])
  
  const memoizedSetSelectedSystemFilter = useCallback((system: string) => {
    setSelectedSystemFilter(system)
  }, [setSelectedSystemFilter])
  
  const memoizedSetDrilldownDivision = useCallback((division: string | null) => {
  ...
  }), [selectedPeriod, selectedDivisionFilter, selectedDepartmentFilter, selectedSystemFilter, drilldownDivision, memoizedSetSelectedPeriod, memoizedSetSelectedDivisionFilter, memoizedSetSelectedDepartmentFilter, memoizedSetSelectedSystemFilter, memoizedSetDrilldownDivision])
}
...
export const useUarProgressComputed = () => {
  const getDivisionOptions = useUarProgressStore(state => state.getDivisionOptions)
  const getDivisionChartData = useUarProgressStore(state => state.getDivisionChartData)
  const getDepartmentOptions = useUarProgressStore(state => state.getDepartmentOptions)
  const getSystemOptions = useUarProgressStore(state => state.getSystemOptions)
  const getDepartmentChartData = useUarProgressStore(state => state.getDepartmentChartData)
  const getSystemChartData = useUarProgressStore(state => state.getSystemChartData)
  ...
  return useMemo(() => ({
    ...
    getSystemChartData,
    getGrandTotal,
  }), [getDivisionOptions, getDivisionChartData, getDepartmentOptions, getSystemOptions, getDepartmentChartData, getSystemChartData, getGrandTotal])
}
